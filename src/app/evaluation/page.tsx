    ...
    <div className="min-h-screen flex" style={{ backgroundColor: darkMode ? "#1E293B" : "#F8FAFC" }}>
      ...
      <main className="flex-1 overflow-auto">
        <header className="px-8 py-4 flex items-center justify-between relative" style={{ backgroundColor: darkMode ? "#1E293B" : "#FFFFFF", borderBottom: darkMode ? "1px solid #475569" : "1px solid #E2E8F0" }}>
          <h2 className="text-lg font-bold" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Evaluation</h2>
        ...
        <div className="p-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 rounded-2xl" style={{ backgroundColor: darkMode ? "#334155" : "#FFFFFF", boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)' }}>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Upload Your Evaluation</h3>
              </div>
              ...
              {uploadedFile ? (
                ...
                <div className="p-4 rounded-xl" style={{ backgroundColor: darkMode ? "#1E293B" : "#F8FAFC", border: darkMode ? "1px solid #475569" : "1px solid #E2E8F0" }}>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => { setUploadedFile(null); setFileName(""); }} style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>✕</button>
                  </div>
                </div>
                <div className="p-4 rounded-xl" style={{ border: darkMode ? "1px solid #475569" : "1px solid #E2E8F0", minHeight: "500px" }}>
                  <div className="flex items-center justify-center h-full" style={{ minHeight: "450px" }}>
                    <div className="text-center">
                      <svg className="w-12 h-12 mx-auto mb-3" style={{ color: darkMode ? "#94A3B8" : "#94A3B8" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                      <p className="text-sm" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>File preview</p>
                      <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#94A3B8" }}>PDF/DOCX viewer would render here</p>
                    </div>
                  </div>
                </div>
                  <div className="flex items-center justify-between pt-4">
                    ...
                    <button onClick={() => {
                      const submission = { id: Date.now().toString(), type: "evaluation", studentName: session?.name || "Student", studentId: session?.studentId || "", title: `Evaluation - ${fileName}`, status: "pending", submittedAt: new Date().toISOString(), isUrgent, fileName };
                    ...
                    }} className="px-4 py-2 rounded-xl text-sm font-medium text-white" style={{ backgroundColor: "#16A34A" }}>Submit</button>
                  </div>
                </div>
              ) : (
                <div className="p-12 rounded-xl flex flex-col items-center justify-center" style={{ border: "2px dashed", borderColor: darkMode ? "#475569" : "#E2E8F0" }}>
                  <svg className="w-12 h-12 mb-4" style={{ color: darkMode ? "#94A3B8" : "#94A3B8" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                  </svg>
                  <p className="text-sm font-medium mb-2" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Upload your Evaluation</p>
                  <p className="text-xs mb-4" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>Supported formats: PDF, DOCX, JPG, PNG</p>
                  <button onClick={handleFileUpload} className="px-4 py-2 rounded-xl text-sm font-medium text-white" style={{ backgroundColor: "#00529B" }}>Choose File</button>
                </div>
              )}
            </div>

            <div className="p-6 rounded-2xl" style={{ backgroundColor: darkMode ? "#334155" : "#FFFFFF", boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}>
              <h3 className="text-lg font-semibold mb-4" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>About Evaluation</h3>
              <div className="space-y-4">
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Student Evaluation</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>Performance review.</p>
                </div>
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Includes</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>Work performance, Attendance, Behavior</p>
                </div>
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Result</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>Rating and feedback</p>
                </div>
              </div>
            </div>
          </div>
