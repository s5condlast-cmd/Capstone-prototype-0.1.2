    ...
    <div className="min-h-screen flex" style={{ backgroundColor: darkMode ? "#1E293B" : "#F8FAFC" }}>
      ...
      <main className="flex-1 overflow-auto">
        <header className="px-8 py-4 flex items-center justify-between relative" style={{ backgroundColor: darkMode ? "#1E293B" : "#FFFFFF", borderBottom: darkMode ? "1px solid #475569" : "1px solid #E2E8F0" }}>
          <h2 className="text-lg font-bold" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Daily Time Record (DTR)</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 rounded-2xl" style={{ backgroundColor: darkMode ? "#334155" : "#FFFFFF", boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)' }}>
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Upload Your Daily Time Record</h3>
              </div>
              ...
              {uploadedFile ? (
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl" style={{ border: darkMode ? "1px solid #475569" : "1px solid #E2E8F0", minHeight: "300px" }}>
                  ...
                  <div className="flex items-center justify-between pt-4">
                    ...
                    <button onClick={() => {
                      const submission = { id: Date.now().toString(), type: "dtr", studentName: session?.name || "Student", studentId: session?.studentId || "", title: `DTR - ${fileName}`, status: "pending", submittedAt: new Date().toISOString(), isUrgent, fileName };
                    ...
                    }} className="px-4 py-2 rounded-xl text-sm font-medium text-white" style={{ backgroundColor: "#16A34A" }}>Submit DTR</button>
                  </div>
                </div>
              ) : (
                <div className="p-12 rounded-xl flex flex-col items-center justify-center" style={{ border: "2px dashed", borderColor: darkMode ? "#475569" : "#E2E8F0" }}>
                  ...
                  <p className="text-sm font-medium mb-2" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Upload your Daily Time Record</p>
            ...
            <div className="p-6 rounded-2xl" style={{ backgroundColor: darkMode ? "#334155" : "#FFFFFF", boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }}>
              <h3 className="text-lg font-semibold mb-4" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>About DTR</h3>
              <div className="space-y-4">
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Daily Time Record (DTR)</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>Used for tracking practicum hours only.</p>
                </div>
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Required Hours</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>486 hours</p>
                </div>
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Format</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>PDF, DOCX, JPG, PNG</p>
                </div>
                <div>
                  <p className="text-sm font-medium mb-1" style={{ color: darkMode ? "#F8FAFC" : "#1E293B" }}>Status</p>
                  <p className="text-xs" style={{ color: darkMode ? "#94A3B8" : "#64748B" }}>Manual Entry System</p>
                </div>
              </div>
            </div>
          </div>
